...
def exercise_analysis(df):
    """
    Exercise 1: Modify the Data Processor
    ...
    revenue_per_region_per_day = df.groupby(['region', 'date'])['revenue'].sum()
    print("\n📊 Total Revenue per Region per Day:")
    print(revenue_per_region_per_day)
